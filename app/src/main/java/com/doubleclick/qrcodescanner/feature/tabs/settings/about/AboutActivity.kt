package com.doubleclick.qrcodescanner.feature.tabs.settings.about
import android.content.Intent
import android.net.Uri
import androidx.appcompat.app.AppCompatActivity
import android.os.Bundle
import com.doubleclick.qrcodescanner.BuildConfig
import com.doubleclick.qrcodescanner.R
import com.doubleclick.qrcodescanner.databinding.ActivityAboutBinding
...
class AboutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.itemSettingsMoreAboutGithub.setOnClickListener {
            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/D4rK7355608/com.doubleclick.qrcodescanner"))
            startActivity(intent)
        }
